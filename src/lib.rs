...
/// # Example
/// ```
/// #![cfg_attr(feature = "const-default-impls", feature(const_default_impls))] // required for constants
///
/// #[portrait::make]
/// trait Foo {
///     #[cfg(feature = "const-default-impls")] const BAR: i32;
///     fn qux() -> u64;
/// }
///
/// struct Corge;
...
/// impl Foo for Corge {}
///
/// #[cfg(feature = "const-default-impls")] assert_eq!(Corge::BAR, 0i32);
...
///
/// See the documentation of other macros for example usage.
#[doc(inline)]
